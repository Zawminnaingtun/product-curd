...
const ProductEditCard = () => {
  ...
  return (
    <div className="bg-stone-100 p-5 rounded-lg w-full md:w-1/2">
      ...
      {isLoading ? (
        <div className="animate-pulse p-6 bg-white rounded-xl shadow-sm max-w-xl mx-auto space-y-6">
          {/* Product Name */}
          ...
          <div className="">
            <div className="mb-5">
              ...
              <input
                ...
                defaultValue={data?.product_name} //data call
            ...
            <div className="mb-8">
              ...
              <input
                ...
                defaultValue={data?.price} //data call
                className={`bg-gray-50 border  text-gray-900 text-sm rounded-lg ${
                  errors.price
                    ? "border-red-500 focus:ring-red-500 focus:border-red-500"
                    : "border-gray-300 focus:ring-blue-500 focus:border-blue-500"
              ...
              {errors.price?.type === "max" && (
                <p className="text-red-500 text-sm mt-1">
                  Product name must be less than 10000 characters
                </p>
              )}
            </div>
